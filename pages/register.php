...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h1 class="text-center my-4" style="font-family: 'Pacifico', cursive;">Register</h1>
            <form action="?page=register_process" method="post" id="registerForm" class="form-group">
                <div class="mb-3">
